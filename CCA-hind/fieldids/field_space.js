...
// Specify the path to the input JSON file (field_ids.json)
const inputFilePath = '/home/ashraf.rahul/Desktop/CCA-hind/fieldids/field_ids.json;' // Replace with your input file path

// Specify the path to the output JSON file (you can use the same or a different file)
const outputFilePath = 'field_ids.json'; // Replace with your desired output file path
